<p>
	<u>Responsible for the content of this website:</u><br>
	Timon Ostertun<br>
	Pferdekoppel 71<br>
	22880 Wedel<br>
	Germany<br>
	<a href="http://timon.ostertun.de">timon.ostertun.de</a><br>
	<a href="mailto:timon@ostertun.de">timon@ostertun.de</a><br>
</p>

<p>
	<a style="width: calc(100% / 2 - 24px); display: block; float: left; background: <?php if (isset($request[0]) and ($request[0] == 'disc')) { echo '#00aaff'; } else { echo '#0000ff'; } ?>; color: <?php if (isset($request[0]) and ($request[0] == 'disc')) { echo '#000000'; } else { echo '#ffffff'; } ?>; margin-left: 2px; margin-right: 2px; margin-bottom: 10px; padding: 10px; text-decoration: none; text-align: center;" href="<?php echo LINK_PRE; ?>imprint/disc">Disclaimer</a>
	<a style="width: calc(100% / 2 - 24px); display: block; float: left; background: <?php if (isset($request[0]) and ($request[0] == 'data')) { echo '#00aaff'; } else { echo '#0000ff'; } ?>; color: <?php if (isset($request[0]) and ($request[0] == 'data')) { echo '#000000'; } else { echo '#ffffff'; } ?>; margin-left: 2px; margin-right: 2px; margin-bottom: 10px; padding: 10px; text-decoration: none; text-align: center;" href="<?php echo LINK_PRE; ?>imprint/data">Privacy Statement</a>
</p>
...
<p><strong>The disclaimer is currently only available in German.</strong> We are working to offer it in English too.</p>
...
<p><strong>The Privacy Statement is currently only available in German.</strong> We are working to offer it in English too.</p>
...
<p><a href="mailto:timon@ostertun.de">timon@ostertun.de</a></p>
